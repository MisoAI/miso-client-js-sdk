...
│   └── Message (one conversation message, behind <miso-message>; data actor off — fed by Conversation via updateData())
...
├── Messages — Message instances keyed by question id (the conversation panel's items)
